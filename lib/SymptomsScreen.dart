...
class symptomsWidget extends StatefulWidget {
  List symptoms, symptoms2;

  symptomsWidget(this.symptoms, this.symptoms2);
                                    ...
                                    itemBuilder:
                                      ...
                                      return Center(
                                        child: GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              symptomsVisibility = true;
                                              someMap[widget.symptoms[index]] =
                                                  index;
                                              namesList
                                                  .add(widget.symptoms[index]);
                                              selectedSymptom =
                        ...
                        Expanded(
                          child: Column(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: GridView.builder(
                                    itemCount: widget.symptoms2.length,
                                    gridDelegate:
                                        new SliverGridDelegateWithFixedCrossAxisCount(
                                            childAspectRatio: 4 / 2,
                                            crossAxisCount: 4),
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              ...
                                              someMap2[widget
                                                  .symptoms2[index]] = index;
                                              namesList2
                                                  .add(widget.symptoms2[index]);
                                              selectedSymptom =
                                                  widget.symptoms2[index];
                                              leftSideController.forward();
                                              widget.symptoms2.removeAt(index);
                                            });
                                          },
                                          child: Container(
                                            padding: const EdgeInsets.all(15.0),
...
//                                              color: Color(0xffFFF2F7),
                                            ...
                                            child: Text(widget.symptoms2[index],
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontWeight:
                                                        FontWeight.bold)),
